<template>
    <div class="page-home">
      <div class="header flex justify-center items-center h-16 justify-between w-full px-6">
        <a class="headerLogo" href="">
          <svg class="text-black" width="40" height="40" viewBox="0 0 50 50" fill="currentColor">
        ...
        <div class="headerList flex justify-center items-center font-bold">
          <a class="text-black mr-7" href="">Docs</a>
          <a class="text-black mr-7" href="">About</a>
          <a class="text-black" href="">SUPPORT US</a>
        </div>
      </div>
